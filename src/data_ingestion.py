...
def load_data(data_url : str) -> pd.DataFrame:
    ...
    try:
        ...
        logger.error('failed to parse the scve file: %s', e)
        raise
    except Exception as e:
        logger.error('Unexpected error occured while loaded the data: %s', e)
        raise
...
def preprocess_data(df : pd.DataFrame) -> pd.DataFrame:
    ...
    try:
        ...
        logger.error('unexpected error durign data preprocessing: %s', e)
        raise
...
def main():
    try:
        ...
        logger.error('Failed to complete the data ingesiton process: %s', e)
        print(f"Error : {e}")
