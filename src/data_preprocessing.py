...
def Transform_text(text):
    ...
    #remove non alphaneumeric tokens
    text = [word for word in text if word.isalnum()]
    # remove the stopword and punctuations 
...
"""
    try:
        ...
        logger.debug('dublicates removed')
...
def main(text_column= 'text', target_column='target'):
    """ main function to to load raw data, preprocess it and saved the preprocesses data """
    try:
        ...
        logger.debug('reprocessed data saved to %s', data_path)
    except FileNotFoundError as e:
        logger.error('found not found: %s', e)
